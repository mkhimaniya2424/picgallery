    ...
    try {
      ...
      if (newUrl != null) {
        ...
        if (currentUser != null) {
          ref
              ...
              .setUser(currentUser.copyWith(avatarUrl: newUrl));
        }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
                'Error uploading image: ${e is ApiException ? e.message : e}'),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              shape: BoxShape.circle,
                              border: Border.all(
                                  color: (Theme.of(context).brightness == Brightness.dark ? AppColors.darkSurface : AppColors.surface), width: 2),
                            ),
